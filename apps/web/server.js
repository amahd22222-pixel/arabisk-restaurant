...
import { registerBannerVideoRoutes } from './banner-video-routes.js';
...
const restoreBannerVideos = registerBannerVideoRoutes(app, { storageReady, presign, readJson, writeJson, deleteObject });
